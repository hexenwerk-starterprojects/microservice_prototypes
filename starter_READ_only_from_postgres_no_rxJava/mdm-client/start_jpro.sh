...
JPRO_ARGS=("-Xmx1000m" "-Djpro.applications.default=cz.hexenwerk.sandbox.mdmservice.client.javfx.JavaFxClientApplication" "-Dprism.useFontConfig=false" "-Djpro .forceShutdown=true" "-Dhttp.port=80" "-Dquantum.norenderjobs=true" "-Dglass.platform=Monocle" "-Dmonocle.platform=Headless" "-Dprism.fontdir=fonts/" "-Djpro .deployment=MAVEN-Distribution")

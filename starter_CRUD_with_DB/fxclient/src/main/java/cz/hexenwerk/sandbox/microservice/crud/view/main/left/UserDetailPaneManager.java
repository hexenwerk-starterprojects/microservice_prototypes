package cz.hexenwerk.sandbox.microservice.crud.view.main.left;
...
public class UserDetailPaneManager {
        ...
        if (validate("First Name", userDetailPane.firstName.getText(), "[a-zA-Z]+") &&
            ...
            if (userDetailPane.userId.getText() == null || userDetailPane.userId.getText() == "") {
                if (validate("Email", userDetailPane.getEmail(), "[a-zA-Z0-9][a-zA-Z0-9._]*@[a-zA-Z0-9]+([.][a-zA-Z]+)+") &&
                    ...
                    user.setDob(Date.valueOf(userDetailPane.getDob()));
    ...
    public void refreshUserPane(User user) {
        ...
        userDetailPane.dob.setValue(new java.sql.Date(user.getDob().getTime()).toLocalDate());
...
//        alert.show();
        // TODO:jako showAndWait does not work with JPro. Figure out other way of how to block the dialog
        alert.showAndWait();
    }

package cz.hexenwerk.sandbox.microservice.crud.view.main.top;

import cz.hexenwerk.sandbox.microservice.crud.MainApp;
import cz.hexenwerk.sandbox.microservice.crud.view.ResourceBundleUtil;
